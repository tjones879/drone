...
OBJS = $(CPPFILES:%.cpp=$(BUILD_DIR)/%.o) $(CFILES:%.c=$(BUILD_DIR)/%.o)
...
TGT_CFLAGS += -Wredundant-decls -Wstrict-prototypes -Wmissing-prototypes -Wno-shadow

TGT_CXXFLAGS += $(OPT) $(CXXSTD) -ggdb3
TGT_CXXFLAGS += $(ARCH_FLAGS) --std=c++17
TGT_CXXFLAGS += -fno-common -fno-threadsafe-statics -fno-exceptions -fno-rtti -fno-use-cxa-atexit
TGT_CXXFLAGS += -ffunction-sections -fdata-sections -flto
TGT_CXXFLAGS += -Wextra -Wshadow -Wredundant-decls  -Weffc++ -Wall
TGT_CXXFLAGS += -Wcast-align -Wunused -Wpedantic -Wconversion -Wlogical-op -Wuseless-cast
...
$(BUILD_DIR)/%.o: %.c
	@printf "  CC\t$<\n"
	@mkdir -p $(dir $@)
	$(Q)$(CC) $(TGT_CFLAGS) $(CFLAGS) $(TGT_CPPFLAGS) $(USER_DEFINES) -o $@ -c $<

$(BUILD_DIR)/%.o: %.cpp
	@printf "  CXX\t$<\n"
	@mkdir -p $(dir $@)
	$(Q)$(CC) $(TGT_CXXFLAGS) $(CXXFLAGS) $(TGT_CPPFLAGS) $(CPPFLAGS) $(USER_DEFINES) -o $@ -c $<
